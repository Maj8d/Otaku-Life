...
class AnimeListUser extends StatefulWidget {
  const AnimeListUser({super.key, required this.userId});
  final int userId;

  @override
  State<AnimeListUser> createState() => _AnimeListUserState();
}

class _AnimeListUserState extends State<AnimeListUser> {
  UserModel? userData;
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => ProfilePage(userId: widget.userId ??0)));
                    },
